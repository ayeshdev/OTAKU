      ...
      <div class="slider-wrapper my-40 my-sm-25 float-left w-100">
        <div class="container">
          ...
          <div class="slider slider-for owl-carousel">
            <div>
              <a href="#">
                <img src="${BASE_URL}assets/img/slider/sample-01.jpg" alt="" height="800" width="1600"/>
              </a>
            ...
            <div>
              <a href="#">
                <img src="${BASE_URL}assets/img/slider/sample-02.jpg" alt="" height="800" width="1600"/>
              </a>
          ...
          <div class="ttbannerblock container text-center">
            <div class="row">
              <div class="ttbanner1 ttbanner col-sm-6 col-xs-6 left-to-right hb-animate-element">
                <div class="ttbanner-img"><a href="#"><img src="${BASE_URL}assets/img/banner/cms-01.jpg" alt="cms-01" height="600" width="630"></a></div>
              ...
              <div class="ttbanner2 ttbanner col-sm-6 col-xs-6 right-to-left hb-animate-element">
                <div class="ttbanner-img"><a href="#"><img src="${BASE_URL}assets/img/banner/cms-02.jpg" alt="cms-02" height="600" width="630"></a></div>
                <div class="ttbanner-inner d-inline-block align-top float-none">
                      ...
                      <div class="ttfeatured-content products grid owl-carousel" id="owl1">
                          ...
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/01.jpg" alt="01" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/02.jpg" alt="02" class="second_image img-responsive" height="501" width="385"/>										</a>
                            ...
                            <div class="thumb-description">
                              <div class="caption">
                                <h4 class="product-title text-capitalize"><a href="${BASE_URL}assets/product-details.html">Merino Small Dress</a></h4>
                              </div>
                              <div class="rating">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/02.jpg" alt="02" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/03.jpg" alt="03" class="second_image img-responsive" height="501" width="385"/>										</a>
                              <div class="flags">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/03.jpg" alt="03" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/04.jpg" alt="04" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/04.jpg" alt="04" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/05.jpg" alt="05" class="second_image img-responsive" height="501" width="385"/>										</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/05.jpg" alt="05" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/06.jpg" alt="06" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/06.jpg" alt="06" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/07.jpg" alt="07" class="second_image img-responsive" height="501" width="385"/>										</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/07.jpg" alt="07" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/08.jpg" alt="08" class="second_image img-responsive" height="501" width="385"/>										</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/08.jpg" alt="03" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/09.jpg" alt="09" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                      ...
                      <div class="ttnew-content products grid owl-carousel" id="owl2">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/02.jpg" alt="02" height="501" width="385"/>
                                <img src="${BASE_URL}assets/${BASE_URL}assets/img/products/03.jpg" alt="03" class="second_image img-responsive" height="501" width="385"/>									</a>								</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/05.jpg" alt="05" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/06.jpg" alt="06" class="second_image img-responsive" height="501" width="385"/></a>
                            </div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/07.jpg" alt="03" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/08.jpg" alt="08" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/08.jpg" alt="08" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/09.jpg" alt="09" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                      ...
                      <div class="ttbestseller-content products grid owl-carousel" id="owl3">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/02.jpg" alt="02" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/03.jpg" alt="03" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/04.jpg" alt="03" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/05.jpg" alt="05" class="second_image img-responsive" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/05.jpg" alt="03" height="501" width="385"/>
                                <img src="${BASE_URL}assets/img/products/06.jpg" alt="06" class="second_image img-responsive" height="501" width="385"/>									</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/06.jpg" alt="03" height="501" width="385"/>										</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/07.jpg" alt="03" height="501" width="385"/>										</a>									</div>
                            <div class="thumb-description">
                              <div class="caption">
                                <h4 class="product-title text-capitalize"><a href="product-details.html">Tropical Shirt Dress</a></h4>
                              </div>
                        ...
                        <div class="product-layouts">
                          <div class="product-thumb">
                            <div class="image zoom">
                              <a href="product-details.html">
                                <img src="${BASE_URL}assets/img/products/08.jpg" alt="03" height="501" width="385"/></a></div>
                            <div class="thumb-description">
                              <div class="caption">
                ...
                <div class="tttestimonial owl-carousel">
                  <div>
                    <div class="testimonial-block">
                      <div class="testimonial-image"><img alt="" src="${BASE_URL}assets/img/banner/user1.jpg" height="120" width="120"/></div>
                  ...
                  <div>
                    <div class="testimonial-block">
                      <div class="testimonial-image"><img alt="" src="${BASE_URL}assets/img/banner/user2.jpg" height="120" width="120"/></div>
                      <div class="testimonial-content">
                        <div class="testimonial-desc">
                          <p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam mattis arcu convallis, bibendum dui ac, laoreet est.Vivamus interdum egastas rutrum. Quisque laoreet ante sed placerat imperdiet.
                          </p>
                  ...
                  <div>
                    <div class="testimonial-block">
                      <div class="testimonial-image"><img alt="" src="${BASE_URL}assets/img/banner/user3.jpg" height="120" width="120"/></div>
                      <div class="testimonial-content">
                        <div class="testimonial-desc">
                          <p>Duis faucibus enim vitae nunc molestie, nec facilisis arcu pulvinar. Nullam mattis arcu convallis, bibendum dui ac, laoreet est.Vivamus interdum egastas rutrum. Quisque laoreet ante sed placerat imperdiet.
                          </p>
            ...
            <div class="ttbannerblock container">
              <div class="row">
                <div class="ttbanner1 ttbanner col-sm-6 col-xs-6">
                  <div class="ttbanner-img"><a href="#"><img src="${BASE_URL}assets/img/banner/cms-03.jpg" alt="cms-03" height="600" width="400"></a></div>
                ...
                <div class="ttbanner2 ttbanner col-sm-6">
                  <div class="ttbanner-img"><a href="#"><img src="${BASE_URL}assets/img/banner/cms-04.jpg" alt="cms-04" height="600" width="400"></a></div>
                  <div class="ttbanner-inner">
                    <div class="ttbanner-desc text-center">
                ...
                <div class="smartblog-content owl-carousel">
                  <div class="ttblog">
                    <div class="item">
                      <div class="ttblog_image_holder">
                        <a href="#">
                          <img src="${BASE_URL}assets/img/banner/blog-01.jpg" alt="blog-01" width="415" height="269">							</a>
                        <span class="blogicons">
                                        <a title="Click to view Full Image" href="${BASE_URL}assets/img/banner/blog-01.jpg" data-lightbox="example-set" class="icon zoom"><i class="material-icons">search</i></a>							</span>					  </div>
                  ...
                  <div class="ttblog">
                    <div class="item">
                      <div class="ttblog_image_holder">
                        <a href="#">
                          <img src="${BASE_URL}assets/img/banner/blog-02.jpg" alt="blog-02" width="415" height="269">							</a>
                        <span class="blogicons">
                                        <a title="Click to view Full Image" href="${BASE_URL}assets/img/banner/blog-02.jpg" data-lightbox="example-set" class="icon zoom"><i class="material-icons">search</i></a>							</span>					  </div>
                      <div class="blog-content-wrap float-left w-100">
                        <div class="blog_inner">
                  ...
                  <div class="ttblog">
                    <div class="item">
                      <div class="ttblog_image_holder">
                        <a href="#">
                          <img src="${BASE_URL}assets/img/banner/blog-03.jpg" alt="blog-03" width="415" height="269">							</a>
                        <span class="blogicons">
                                        <a title="Click to view Full Image" href="${BASE_URL}assets/img/banner/blog-03.jpg" data-lightbox="example-set" class="icon zoom"><i class="material-icons">search</i></a>							</span>					  </div>
                      <div class="blog-content-wrap float-left w-100">
                        <div class="blog_inner">
                  ...
                  <div class="ttblog">
                    <div class="item">
                      <div class="ttblog_image_holder">
                        <a href="#">
                          <img src="${BASE_URL}assets/img/banner/blog-04.jpg" alt="blog-04" width="415" height="269">							</a>
                        <span class="blogicons">
                                        <a title="Click to view Full Image" href="${BASE_URL}assets/img/banner/blog-04.jpg" data-lightbox="example-set" class="icon zoom"><i class="material-icons">search</i></a>							</span>					  </div>
                      <div class="blog-content-wrap float-left w-100">
                        <div class="blog_inner">
                  ...
                  <div class="ttblog">
                    <div class="item">
                      <div class="ttblog_image_holder">
                        <a href="#">
                          <img src="${BASE_URL}assets/img/banner/blog-05.jpg" alt="blog-05" width="415" height="269">							</a>
                        <span class="blogicons">
                                        <a title="Click to view Full Image" href="${BASE_URL}assets/img/banner/blog-05.jpg" data-lightbox="example-set" class="icon zoom"><i class="material-icons">search</i></a>							</span>					  </div>
                      <div class="blog-content-wrap float-left w-100">
                        <div class="blog_inner">
                          <h4 class="blog-title"><span>Share the Love</span></h4>
                          <div class="blog-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
          ...
          <div id="ttbrandlogo" class="my-40 my-sm-25 bottom-to-top hb-animate-element">
            <div class="container">
              <div class="tt-brand owl-carousel">
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-01.png" alt="brand-logo-01" width="140" height="100"></a>
                </div>
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-02.png" alt="brand-logo-02" width="140" height="100"></a>
                </div>
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-03.png" alt="brand-logo-03" width="140" height="100"></a>
                </div>
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-04.png" alt="brand-logo-04" width="140" height="100"></a>
                </div>
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-05.png" alt="brand-logo-05" width="140" height="100"></a>
                </div>
                <div class="item">
                  <a href="#"><img src="${BASE_URL}assets/img/logos/brand-logo-06.png" alt="brand-logo-06" width="140" height="100"></a>
                </div>
              </div>
            </div>
          </div>
