    ...
    <div class="header-nav">
      <div class="container">
        ...
        <div class="nav-right float-right d-flex">
          <div class="ttheader-mail"><a href="mailto:otakusrilanka@gmail.com">otakusrilanka@gmail.com</a></div>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="header-left float-left d-flex d-lg-flex d-md-block d-xs-block">
            <div class="language-wrapper toggle">
              <button type="button" class="btn text-capitalize dropdown-toggle"><img src="${BASE_URL}assets/img/banner/en.png" alt="en" height="12" width="18"/><span>English</span></button>
              <div id="language-dropdown" class="language">
                <ul>
                  <li><img src="${BASE_URL}assets/img/banner/en.png" alt="en" width="18" height="12"/><span>English</span></li>
                  <li><img src="${BASE_URL}assets/img/banner/fr.png" alt="fr" width="18" height="12"/><span>French</span></li>
                </ul>
              </div>
            </div>
            ...
            <div class="contact">
              ...
              <a href="tel:+94703889596">0703889596</a>
            </div>
          </div>
                  ...
                  <div class="dropdown-menu mega-menu v-2 z-depth-1 special-color py-3 px-3" id="menu3">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-xl-4 sub-menu mb-0">
                        ...
                        <ul class="list-unstyled">
                          <li>
                            <span class="menu-banner"><img src="${BASE_URL}assets/img/banner/menu-banner.jpg" alt="menu-banner" width="210" height="300"/></span>                </li>
                        </ul>
                      </div>
                    </div>
                  </div>
