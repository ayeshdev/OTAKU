...
public class ProductDTO {
    ...
    public ProductDTO(Long id, String name, Double price, Integer qty_id) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.qty_id = qty_id;
    ...
    public ProductDTO(Long id, String name, Double price, Integer category_id, Integer color_id, Integer size_id) {
        this.id = id;
        this.name = name;
        this.price = price;
